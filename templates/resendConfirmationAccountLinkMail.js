export default function resendConfirmationAccountLinkMailMail (confirmationToken) {
                                                        ...
                                                        <tr>
                                                          <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:40px 20px 25px;font-family:helvetica,sans-serif;" align="left">
                                                            <div class="v-font-size" style="font-size: 20px; color: #0a0a0a; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                              <p style="line-height: 140%;">Here is your new code to confirm your account. Remember that it is valid for 24 hours, then you will have to <a rel="noopener" href="${frontendUrl}/resend-confirmation-account-link" target="_blank">request another one</a>.</p>
                                                            </div>
                                                          </td>
                                                        </tr>
                                                      </tbody>
